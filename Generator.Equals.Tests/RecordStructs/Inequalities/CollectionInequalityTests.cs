...
public partial class CollectionInequalityTests
{
    ...
    [Equatable]
    public partial record struct IntKeyDictSample
    {
        [UnorderedEquality]
    ...
    [Equatable]
    public partial record struct IntSetSample
    {
        [SetEquality]
    ...
    [Equatable]
    public partial record struct CoordinateSetSample
    {
        [SetEquality]
    ...
    [Equatable]
    public partial record struct CoordinateDictSample
    {
        [UnorderedEquality]
    ...
    public void EquatableValueDict_MixedChanges_ReportsAll()
    {
        ...
        diffs.Should().Contain(d =>
            ...
            && d.Left == null && d.Right!.Equals(addedPoint));
    }
