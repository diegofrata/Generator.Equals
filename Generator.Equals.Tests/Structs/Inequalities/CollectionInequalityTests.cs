...
public partial class CollectionInequalityTests
{
    ...
    [Equatable]
    public partial struct IntKeyDictSample
    {
        [UnorderedEquality]
    ...
    [Equatable]
    public partial struct IntSetSample
    {
        [SetEquality]
    ...
    [Equatable]
    public partial struct CoordinateSetSample
    {
        [SetEquality]
    ...
    [Equatable]
    public partial struct CoordinateDictSample
    {
        [UnorderedEquality]
