...
public partial class PrecisionEqualityTests : SnapshotTestBase
{
    ...
    {
        var a = new SampleDouble { Value = 1.0 };
        var b = new SampleDouble { Value = 1.002 };
    ...
    {
        var a = new SampleFloat { Value = 1.0f };
        var b = new SampleFloat { Value = 1.02f };
    ...
    {
        var a = new SampleDecimal { Value = 1.0m };
        var b = new SampleDecimal { Value = 1.0002m };
    ...
    {
        var a = new SampleNullableDouble { Value = 1.0 };
        var b = new SampleNullableDouble { Value = null };
    ...
    {
        var a = new SampleNullableDouble { Value = null };
        var b = new SampleNullableDouble { Value = 1.0 };
    ...
    {
        var a = new SampleNullableDouble { Value = 1.0 };
        var b = new SampleNullableDouble { Value = 1.002 };
    ...
    {
        var a = new SampleInt { Value = 10 };
        var b = new SampleInt { Value = 16 };
    ...
    {
        var a = new SampleNullableInt { Value = 10 };
        var b = new SampleNullableInt { Value = null };
    ...
    {
        var a = new SampleNullableInt { Value = null };
        var b = new SampleNullableInt { Value = 10 };
    ...
    {
        var a = new SampleNullableInt { Value = 10 };
        var b = new SampleNullableInt { Value = 16 };
