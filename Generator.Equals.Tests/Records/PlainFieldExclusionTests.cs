...
public partial class PlainFieldExclusionTests
{
    ...
    public void PlainField_DiffersOnly_StillEqual()
    {
        ...
        EqualityAssert.Verify(new Sample("same", "note-a"), new Sample("same", "note-b"), expectedEqual: true);
    }
    ...
    public void Property_Differs_NotEqual()
    {
        ...
        EqualityAssert.Verify(new Sample("a", "note"), new Sample("b", "note"), expectedEqual: false);
    }

    [Equatable]
    public partial record OptInSample
    {
    ...
    public void OptedInField_Differs_NotEqual()
    {
        ...
        EqualityAssert.Verify(new OptInSample("same", "note-a"), new OptInSample("same", "note-b"), expectedEqual: false);
    }
}
