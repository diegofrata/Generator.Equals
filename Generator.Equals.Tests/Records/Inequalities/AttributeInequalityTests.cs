...
public partial class AttributeInequalityTests
{
    ...
    [Equatable]
    public partial record IgnoredPropertySample
    {
    ...
    [Equatable]
    public partial record StringComparisonSample
    {
    ...
    [Equatable]
    public partial record ReferenceEqualitySample
    {
        [ReferenceEquality]
    ...
    [Equatable]
    public partial record FieldSample
    {
    ...
    [Equatable]
    public partial record CollectionFieldSample
    {
    ...
    [Equatable]
    public partial record IgnoredFieldSample
    {
