...
public partial class CollectionInequalityTests
{
    ...
    [Equatable]
    public partial record IntKeyDictSample
    {
        [UnorderedEquality]
    ...
    [Equatable]
    public partial record IntSetSample
    {
        [SetEquality]
    ...
    [Equatable]
    public partial record CoordinateSetSample
    {
        [SetEquality]
    ...
    [Equatable]
    public partial record CoordinateDictSample
    {
        [UnorderedEquality]
