...
/// <summary>
/// Tests for [Equatable] record with primitive types.
/// </summary>
public partial class PrimitiveEqualityTests : SnapshotTestBase
{
    ...
    public void Inequality_DifferentName()
    {
        var diffs = Sample.EqualityComparer.Default.Inequalities(
            new Sample("Dave", 35), new Sample("John", 35)).ToList();
    ...
    const string SampleSource = """
                                ...
                                [Equatable]
                                public partial record PrimitiveEqualitySample(string Name, int Age);
                                """;
}
