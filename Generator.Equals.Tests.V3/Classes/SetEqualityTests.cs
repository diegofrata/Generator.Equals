...
public partial class SetEqualityTests : SnapshotTestBase
{
    ...
    public void SameSetWithDifferentDuplicates_ShouldBeEqual()
    {
        ...
        var a = new Sample { Properties = new List<int> { 1, 2, 3, 4, 5, 5, 4, 3, 2, 1 } };
        var b = new Sample { Properties = new List<int> { 1, 5, 2, 4, 3 } };
    ...
    {
        var a = new Sample { Properties = new List<int> { 1, 2, 3, 4, 5 } };
        var b = new Sample { Properties = new List<int> { 1, 2, 3, 4 } };
    ...
    public static TheoryData<Sample, Sample, bool> EqualityCases => new()
    {
        ...
        { new Sample { Properties = new List<int> { 1, 1, 2, 2 } }, new Sample { Properties = new List<int> { 1, 2 } }, true },
        // Different sets
